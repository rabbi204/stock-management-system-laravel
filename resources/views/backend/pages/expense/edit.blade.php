    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Welcome to Edit Expense Page!</h4>
    ...
    <div class="row">
        <div class="card">
            <div class="card-header">
                <h5>Update Expense - {{ $expense->expense_title }}</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="reference_no" value="{{ $expense->reference_no }}" disabled class="form-control" />
                            </div>
                        </div> 
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group mb-3">
                                <label>Expense For <span class="text-danger">*</span></label>
                                <input type="text" name="expense_title" value="{{ $expense->expense_title }}" class="form-control" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group mb-3">
                        ...
                        {{-- <div class="col-md-6 col-sm-12">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="controls">
                                        <img id="showImage" src="{{ (!empty($expense->attachment) ? url("upload/images/expense_photo/".$expense->attachment) : url('upload/no_image.jpg') ) }}" alt="" style="height: 60px; width: 80px; border: none;">
                                    </div>
                                </div>
                            </div>
                        </div> --}}
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="expense_note" class="form-control" id="ckeditor-classic" cols="30" rows="3">
