    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Welcome to Create Purchase Page!</h4>
    ...
    <div class="row">
        <div class="card col-md-12">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('purchase.store') }}"  method="POST" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="reference_no" class="form-control" placeholder="Ex: PU0001" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group mb-3">
                                <label>Purchase Date <span class="text-danger">*</span></label>
                                <input type="text" readonly name="purchase_date" class="form-control datepicker" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group mb-3">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="product_weight" placeholder="Ex: 10gm or 10kg" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group mb-3">
