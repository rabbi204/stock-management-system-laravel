    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Welcome to Expense Report Page!</h4>
                    ...
                    <table class="table table-bordered dt-responsive">
                        <thead class="bg-primary text-light">
                            <tr>
                                ...
                                <th width="10%">Order Date(m/d/Y)</th>
                                <th width="20%">Expense For</th>
                                <th width="10%">Expense Category</th>
                                <th width="10%">Amount</th>
                                <th width="35%">Expense Note</th>
                            </tr>
                        </thead>
                        <tbody>
    ...
    <script>
        $(document).ready(function(){
            ...
            function fetch_data(from_date='', to_date=''){
                $.ajax({
                    url: '/report/expense/search/data',
                    method: "POST",
                    ...
                    success: function(data){
                        ...
                        for (let count = 0; count < data.length; count++) {
                           ...
                           output += '<td>'+ data[count].expense_date +'</td>';
                           output += '<td>'+ data[count].expense_title +'</td>';
                           output += '<td>'+ data[count].get_expense_categories_name.name +'</td>';
                           output += '<td>'+ data[count].amount +' tk' +'</td>';
                           output += '<td>'+ data[count].expense_note +'</td></tr>';
