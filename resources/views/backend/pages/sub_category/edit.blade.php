    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Welcome to Edit SubCategory Page!</h4>
    ...
    <div class="row">
        <div class="card">
            <div class="card-header">
                <h5>Edit SubCategory - {{ $sub_category->name }}</h5>
            </div>
            <div class="card-body">
                @include('backend.layouts.partials.message')
                
                <form action="{{ route('sub.category.update', $sub_category->id) }}"  method="POST" autocomplete="off">
                    @csrf
