...
<!-- modal js -->
<script src="<?php echo e(asset('backend/assets/js/pages/modal.init.js')); ?>"></script>

<!-- choices js -->
<script src="<?php echo e(asset('backend/assets/libs/choices.js/public/assets/scripts/choices.min.js')); ?>"></script>

<!-- color picker js -->
<script src="<?php echo e(asset('backend/assets/libs/%40simonwep/pickr/pickr.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/libs/%40simonwep/pickr/pickr.es5.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('backend/assets/js/pages/allchart.js')); ?>"></script>
...
<script src="<?php echo e(asset('backend/assets/js/app.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\stms\resources\views/backend/layouts/partials/scripts.blade.php ENDPATH**/ ?>