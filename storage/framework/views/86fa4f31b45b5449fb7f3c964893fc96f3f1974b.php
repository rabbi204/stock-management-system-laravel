    ...
    <div class="row">
        <div class="card col-md-12">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('product.stock.update')); ?>"  method="POST" autocomplete="off">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stms\resources\views/backend/pages/stock_manage/create.blade.php ENDPATH**/ ?>