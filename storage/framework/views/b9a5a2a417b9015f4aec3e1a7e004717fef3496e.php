                ...
                <div class="container mb-5 mt-3">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                <ul class="list-unstyled">
                                    <li class="text-muted">To: <span style="color: #5d9fc5;"><?php echo e($customer->name); ?></span></li>
                                    <li class="text-muted"><i class="fa fa-map-marker" aria-hidden="true"></i> Address: <?php echo e($customer->address); ?></li>
                                    <li class="text-muted"><i class="fas fa-phone"></i> Mobile No: <?php echo e($customer->phone); ?></li>
                                </ul>
                            </div>
                            <div class="col-xl-4">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($content->qty); ?></td>
                                            <td><?php echo e($content->price); ?> tk</td>
                                            <td><?php echo e($content->qty * $content->price); ?> tk</td>
                                        </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5">
                                <ul class="list-unstyled">
                                    <li class="text-muted ms-3"><span class="text-black me-4">SubTotal:</span><?php echo e(Cart::subtotal()); ?> tk</li>
                                    <li class="text-muted ms-3 mt-2"><span class="text-black me-4">VAT:</span><?php echo e(Cart::tax()); ?> tk</li>
                                </ul>
                                <p class="text-black float-start"><span class="text-black me-3"> Total Amount</span><span style="font-size: 20px;"><?php echo e(Cart::total()); ?> tk</span></p>
                            </div>
                        </div>
                        <hr />
                        <div class="row">
...
<div class="modal fade" id="customerModal" tabindex="-1" aria-labelledby="customerModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('final.invoice')); ?>" method="POST">
                <?php echo csrf_field(); ?>

                <div class="modal-header">
                    <h5 class="modal-title" id="customerModalLabel">Invoice of <?php echo e($customer->name); ?> <span class="pull-right" style="margin-left: 74px;font-size: 13px;">Total: <?php echo e(trim(Cart::total())); ?> tk</span></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pay" value="<?php echo e(str_replace(',', '', Cart::total())); ?>" class="form-control" id="pay">
                        <input type="hidden" value="<?php echo e(str_replace(',', '', Cart::total())); ?>" class="form-control" id="total_amount">
                    </div>
                    <div class="mb-3">
...
<?php echo $__env->make('backend.layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stms\resources\views/backend/pages/pos/invoice.blade.php ENDPATH**/ ?>